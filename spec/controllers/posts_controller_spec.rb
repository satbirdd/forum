...
describe PostsController do
  ...
  describe "GET new" do
    it "assigns a new post as @post" do
      get :new, {sectons_id: 2, locale: "da",  section_id: section.id }, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created post" do
        post :create, {:post => valid_attributes,  section_id: section.id }, valid_session
        post = Post.last
        response.should redirect_to([post.section, post])
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested post" do
        ...
        put :update, {:id => post.to_param, :post => { "these" => "params" },  section_id: section.id }, valid_session
      end

      it "assigns the requested post as @post" do
        post = Post.create! valid_attributes
        put :update, {:id => post.to_param, :post => valid_attributes,  section_id: section.id }, valid_session
        assigns(:post).should eq(post)
      end
      ...
      it "redirects to the post" do
        post = Post.create! valid_attributes
        put :update, {:id => post.to_param, :post => valid_attributes,  section_id: section.id }, valid_session
        response.should redirect_to([section, post])
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the post as @post" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Post.any_instance.stub(:save).and_return(false)
        put :update, {:id => post.to_param, :post => {  },  section_id: section.id }, valid_session
        assigns(:post).should eq(post)
      end
